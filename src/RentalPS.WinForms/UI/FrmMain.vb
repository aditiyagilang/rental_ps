...
Namespace RentalPS.WinForms.UI
    Public Class FrmMain
        ...
        Private Sub BuildLayout()
            ...
            sidebar.Controls.Add(CreateMenuButton("Sparepart", Sub() ShowPage("Sparepart", New FrmPlaceholder("Master Sparepart"))))
            sidebar.Controls.Add(CreateMenuButton("Jasa", Sub() ShowPage("Jasa", New FrmPlaceholder("Master Jasa"))))
            sidebar.Controls.Add(CreateMenuButton("Game", Sub() ShowPage("Game", New FrmPlaceholder("Master Game"))))
            sidebar.Controls.Add(CreateMenuButton("Stok FNB", Sub() ShowPage("Stok FNB", New FrmPlaceholder("Master FNB"))))
            sidebar.Controls.Add(CreateMenuButton("Ruang", Sub() ShowPage("Ruang", New FrmPlaceholder("Master Ruang"))))
            sidebar.Controls.Add(CreateMenuButton("Stok PS", Sub() ShowPage("Stok PS", New FrmPlaceholder("Master PS"))))
